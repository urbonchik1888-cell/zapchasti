...
async function loadUsersFromStorage(){ const data=await ghLoadAllData(); if(data&&Array.isArray(data.users)&&data.users.length>0) return data.users; return JSON.parse(localStorage.getItem('users')||'[]'); }
